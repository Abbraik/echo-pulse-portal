...
const MasterTreemap: React.FC<MasterTreemapProps> = ({ className }) => {
  ...
  const getIndicatorColor = (indicator: IndicatorData): string => {
    if (indicator.type === 'strategic') {
      ...
      if (indicator.value === 0) return 'rgba(0,255,195,0.20)';
      if (indicator.value <= 5) return 'rgba(255,193,7,0.20)';
      return 'rgba(255,110,110,0.20)';
    }
  };
  ...
  const rectangles = calculateTreemapLayout(svgWidth - 32, svgHeight - 32);
  ...
  return (
    <div className={cn('w-full', className)}>
      ...
      <motion.div 
        className={cn(
          'rounded-2xl border border-white/20 overflow-hidden relative transition-all duration-400',
      ...
      >
        ...
        >
          <h2 className="text-base font-bold text-[#00FFC3] font-['Noto_Sans']">
            Master Treemap: Key Monitor Indicators
          </h2>
          <div className="flex items-center gap-3">
            <button 
              className="text-[#00FFC3] hover:text-white transition-colors cursor-grab"
            ...
            <button
              ...
              className={cn(
                ...
                filter === filterOption
                  ...
                  : 'bg-transparent text-[#00FFC3] border border-[#00FFC3]/30 hover:bg-[#00FFC3]/10'
              )}
            >
          ...
          <div className="flex items-center justify-between px-6 py-2 border-b border-white/10">
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-white font-['Noto_Sans']">Near Target</span>
              </div>
              <div className="flex items-center gap-2">
                  ...
                  <rect
                    ...
                    style={{
                      filter: hoveredRect === rect.data.name 
                        ? 'drop-shadow(0 4px 12px rgba(0,255,195,0.5))'
                        : 'none'
                    }}
                  ...
                  {canShowText(rect) ? (
                    <g>
                      <text
                        ...
                        y={rect.height / 2 - 8}
                        textAnchor="middle"
                        className="fill-[#00FFC3] text-sm font-bold font-['Noto_Sans'] pointer-events-none"
                      >
                        {rect.data.name}
                      </text>
                      <text
                        ...
                        y={rect.height / 2 + 12}
                        textAnchor="middle"
                        className="fill-[#E0E0E0] text-xs font-['Noto_Sans'] pointer-events-none"
                      >
                    ...
                    <g>
                      ...
                      <text
                        ...
                        y={rect.height / 2 + 2}
                        textAnchor="middle"
                        className="fill-[#00FFC3] text-xs pointer-events-none"
                      >
                        ℹ
                      </text>
                    </g>
        ...
        {selectedRect && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-2xl rounded-2xl border border-white/20 p-6"
              style={{
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-[#00FFC3] font-['Noto_Sans']">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3 pt-4">
                  <Button className="bg-[#00FFC3] text-white hover:bg-[#00FFC3]/80">
                    Export CSV ▶
                  </Button>
