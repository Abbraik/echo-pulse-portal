export const en = {
  ...
  askAboutAnomalies: "Ask about anomalies or patterns...",
  askAi: "Ask AI",
  metric: "Metric",
  deviation: "Deviation",
  time: "Time",
  ...
  recalibrationDescription: "Adjust parameters to optimize system response",
  escalated: "Escalated to ACT",
  escalatedDescription: "Issue has been escalated to the ACT zone for intervention",
  viewingAlert: "Viewing Alert",
  viewingAlertDescription: "Detailed analysis view is loading in THINK zone",
  parameter: "Parameter",
  applyChanges: "Apply Changes",
  coordinationTracker: "Coordination Gap Tracker",
  noCoordination: "No Coordination",
  strongCoordination: "Strong Coordination",
  coordinationGap: "Coordination Gap Detected",
  meetingScheduled: "Meeting Scheduled",
  meetingScheduledDescription: "Teams meeting has been added to your calendar",
  coordinationStrong: "Coordination is strong in this area",
  schedule: "Schedule",
