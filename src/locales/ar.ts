...
// Think Zone
const thinkZone = {
  strategyZone: "منطقة الرؤى الاستراتيجية",
  thinkCoreDesc: "نمذجة النظام وتحليل السيناريو للتخطيط الاستراتيجي",
  systemFramingStudio: "استوديو تأطير النظام",
  simulationLab: "مختبر المحاكاة",
  deiHubTitle: "مركز DEI والاستشراف",
  equilibriumSolver: "حلال التوازن",
  strategyBuilder: "منشئ الاستراتيجية",
  simulationLabPlaceholder: "سوف تظهر محاكاة هنا. حدد المعلمات للبدء.",
  conservative: "محافظ",
  balanced: "متوازن",
  aggressive: "جريء",
  computeStrategy: "حساب الاستراتيجية",
  parameterSensitivity: "حساسية المعلمة",
  parameterSliders: "شرائح المعلمات",
  parameter: "المعلمة",
  value: "القيمة",
  impact: "التأثير",
  ...
  timelineShift: "تحول الجدول الزمني",
  weeks: "أسابيع",
  ...
  simulationImpact: "تأثير المحاكاة",
  deiChange: "تغيير نتيجة DEI",
  population: "السكان",
  resources: "الموارد",
